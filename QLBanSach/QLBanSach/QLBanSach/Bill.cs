    ...
    public partial class Bill : Form
    {
        ...
        private void BtnDuyet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool isUpdated = billBLL.UpdateBillStatus(selectedBillId, "Success");
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Đường dẫn tới RDLC
                string reportPath = @"C:\Users\NGHIA\Desktop\QLBanSach\QLBanSach\HelpReport\BillReport.rdlc";
        ...
        private void CalculateTotalsFromDataGridView()
        {
            try
            {
                ...
                txtTotalOrder.Text = totalAmount.ToString("C"); // Hiển thị định dạng tiền tệ
            }
            catch (Exception ex)
            {
        ...
        private void CalculateBillDetailTotals()
        {
            try
            {
                ...
                txtTotalBill.Text = totalPrice.ToString("C"); // Hiển thị định dạng tiền tệ
            }
            catch (Exception ex)
            {
